*** Settings ***
Documentation       Create pon slot vlans
...
*** Variables ***
${URI}       /interfaces/pons/{id}/slots/{slot_id}/vlans
${METHOD}    POST

# TODO: Configurar limite de recursos criados, quando endpoint for desenvolvido
