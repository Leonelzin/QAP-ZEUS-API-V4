*** Settings ***
Documentation       Template to be used in endpoints that accept POST method in requests.
...                 Change the ${URI} variable ad adapt the test as needed #21 tests.
...
*** Variables ***
${URI}       /services/firmware/versions/{id}
${METHOD}    POST
