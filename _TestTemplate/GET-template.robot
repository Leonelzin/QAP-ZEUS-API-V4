*** Settings ***
Documentation       Template to be used in endpoints that accept GET method in requests.
...                 Change the ${URI} variable ad adapt the test as needed #4 tests.
...
*** Variables ***
${URI}       /interfaces/wifi/ssids/nodes
${METHOD}    GET
