*** Settings ***
Documentation       Template to be used in endpoints that accept PUT method in requests.
...                 Change the ${URI} variable ad adapt the test as needed #18 tests.
